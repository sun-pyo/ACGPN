...
class AlignedDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        # image = human image
        # path = human segmentation path
        # name = human image name
        # edge =  binary mask of clothes
        # color = color image of clothes
        # mask, colormask = human image --> transform_A
        # pose = 
    ...
    def __len__(self):
        return 1 #len(self.A_paths) // self.opt.batchSize * self.opt.batchSize
